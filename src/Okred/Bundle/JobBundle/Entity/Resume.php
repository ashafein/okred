...
class Resume
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="CandidateInfo", inversedBy="resumeList")
     * @ORM\JoinTable(name="candidate_resume",
     *    joinColumns={@ORM\JoinColumn(name="resume_id", referencedColumnName="id")},
